<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FunctionInfoEdit.aspx.cs"
    Inherits="OA.FunctionInfoEdit" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#form1').submit(function ()//提交表单 
            {
                ...
                if (issuccess) {
                    var options = {
                        url: 'handler/FunctionInfoSaveHandler.ashx', //提交给哪个执行 
                        type: 'POST',
                        dataType: 'json',
        ...
        <div class="tab-content" style="display: block;">
            ...
            <dl>
                <dl>
                    <dt>父名称</dt>
                    <dd>
                        <input name="txtParentName"  readonly="readonly" type="text" id="txtParentName" runat="server" class="input small  readonly"
                            datatype="n" sucmsg=" ">
                ...
                <dl>
                    <dt>URL</dt>
                    <dd>
                        <input name="txtUrl" type="text" id="txtUrl" runat="server" class="input small" datatype="n"
                            sucmsg=" ">
                    </dd>
                </dl>
                <dl>
