<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleInfoEdit.aspx.cs" Inherits="OA.RoleInfoEdit" %>
        ...
        <div class="tab-content" style="display: block;">
            ...
            <dl>
                ...
                <dl>
                    <dt>角色分类</dt>
                    <dd>
                        <input name="txtRoleClass" type="text" id="txtRoleClass" runat="server" class="input small"
                            datatype="n" sucmsg=" ">
                    </dd>
                </dl>
                <dl>
                    <dt>启用</dt>
                    <dd>
                        <input name="txtIsEnable"  type="checkbox" checked="checked" id="txtIsEnable" runat="server" class="input small"
                            datatype="n" sucmsg=" ">
                    </dd>
                </dl>
                <dl>
