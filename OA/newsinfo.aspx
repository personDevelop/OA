<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" AutoEventWireup="true"
    CodeBehind="newsinfo.aspx.cs" Inherits="OA.newsinfo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="1004" border="0" align="center" cellpadding="1" cellspacing="10" bordercolor="#FFFFFF"
        bgcolor="#F6F6F6">
        <tbody>
            <tr>
                <td align="center" valign="top" bgcolor="#FFFFFF" class="bg_qc">
                    <table width="100%" height="27" border="0" cellpadding="8" cellspacing="0" bgcolor="#F6F6F6">
                        <tbody>
                            <tr>
                                <td class="p12">
                                    您的位置：<a href="index.aspx">首页</a>&nbsp;&gt;&gt;&nbsp;公告通知&nbsp;&gt;&gt;&nbsp;
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table height="25" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td class="p24">
                                    <font class="z24">
                                        <div id='news_title' runat="server">
                                        </div>
                                    </font>
                                </td>
                            </tr>
                    ...
                    <table width="96%" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <div id='news_content' runat="server">
                            </div>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td align="center" valign="middle">
                                    <input name="button" type="button" onclick="window.location='javascript:window.print()'"
                                        value="打印此页">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <input name="button2" type="button" onclick="window.location='#'" value="返回顶部">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <input name="button2" type="button" onclick="jscript:window.external.AddFavorite(document.location.href,document.title);"
                                        value="收藏本页">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="95%" border="0" align="center" cellpadding="5" cellspacing="0" style='display: none;'>
                        <tbody>
                            <tr>
                                <td align="left">
                                    <span class="red">上一篇：</span> <a href="show_news.asp?id=10711&amp;jwsid=11">我所召开社区警民恳谈会</a>
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                                    <span class="red">下一篇：</span> <a href="show_news.asp?id=11015&amp;jwsid=11">三江所开展“两会”前统一清查行动</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
