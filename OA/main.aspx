...
font-family: "Microsoft YaHei";
            ...
            body,ul,li,h1{margin:0;padding:0;font-size:12px;}
...
.active a{color: #1963aa;}
.main-tab{height:42px;background: #f5f5f5;border-bottom: 1px solid #e5e5e5;}
...
.drop-box .drop-item li a:hover{ color:#fff; text-decoration:none; background:#55afeb; }
    ...
    <body class='ui-sunny' >
    <form runat=server><asp:HiddenField ID="uid" runat="server" /></form>
				...
				<ul style="display: block;">
					...
					<ul   class='subblock'>
						<li>
							...
							<div class="arrow"></div><div class="expandable"></div><div class=""></div><span class='subMenu'>考勤管理</span>
						</a>
						</li>
						<li>
					  ...
					  <li>
						...
						<li >
						<a  navid="site_channel_field" href="WorkInfoList.aspx" target="mainframe"  class="item">
						<div class="arrow "></div><div class="expandable"></div><div class=""></div><span  class='subMenu'>派工管理</span>
						</a>
						</li>
					</ul>
					</li>
				...
				<ul style="display: block;">
					...
					<ul  class='subblock'>
						<li>
							...
							<div class="arrow"></div><div class="expandable"></div><div class=""></div><span class='subMenu'>系统设置</span>
						</a>
						</li>
						<li>
							<a navid="site_config" href="AdministrativeRegionsList.aspx" target="mainframe" class="item">
							<div class="arrow"></div><div class="expandable"></div><div class=""></div><span class='subMenu'>行政地区</span>
						</a>
						</li>
						<li>
							<a navid="site_config" href="PersonInfoList.aspx" target="mainframe" class="item">
							<div class="arrow"></div><div class="expandable"></div><div class=""></div><span class='subMenu'>用户管理</span>
						</a>
						</li>
						<li>
        ...
        <div class="main-container">
            <iframe name='mainframe' id='mainframe' src='dashboard.html' frameborder=0 style='height: 100%;width: 100%;border: none;'></iframe>
        </div>
		
		<div style='border-top: 1px solid #DADADA;height: 24px;background: rgb(241, 241, 241);bottom: 0;z-index:11111;position: absolute;width: 100%;text-align: center;line-height: 24px;font-size: 12px;color: #929292;'>版权所有：诚达信息科技有限公司 @copywrite 1998-2014</div>
    </body>
</html>
