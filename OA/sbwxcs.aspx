<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sbwxcs.aspx.cs" Inherits="OA.sbwxcs" %>
...
{ text: '维修人', align: 'center', dataField: '处理人', minWidth: 20, width: 70 },
{ text: '维修时间', align: 'center', dataField: '处理日期', minWidth: 30, width: 100 }
        ...
        function exprot() {
            ...
            $.get("handler/ExpaortExcle.ashx", { sbid: $("#txtID").val(), type: 0, name: $("#txtSbName").val() + "维修统计" }, function (data) {
            ...
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a href="javascript:;" id='pic' onclick="tabs(this);" class="selected"><span
                        id="txtSbName" runat="server"></span>设备维修统计</a></li>
                </ul>
            </div>
        </div>
    </div>
