...
<style>
    .edui-default{padding:0;border:none;}
</style>
...
<dl>
                    <dt>编号</dt>
                    <dd> 
                    <input name="txtCODE" type="text" id="txtCODE"  runat="server"  class="input small" style='width:300px;' datatype="n" sucmsg=" ">
                    </dd>
                </dl>
                ...
                <dl>
                    <dt>来源</dt>
                    <dd> 
                    <input name="txtSOURCE" type="text" id="txtSOURCE"  runat="server"   style='width:300px;' class="input small" datatype="n" sucmsg=" ">
                    </dd>
                </dl>
                <dl>
                    <dt>发布日期</dt>
                    <dd> 
                    <input name="txtPUBDATE" type="text" id="txtPUBDATE"  runat="server"   style='width:300px;' class="input small" datatype="n" sucmsg=" ">
                    </dd>
                </dl>
                ...
                <dl>
                    <dt>发布人</dt>
                    <dd> 
                    <input name="txtPUBUSER" type="text" id="txtPUBUSER"  runat="server"  class="input small"  style='width:300px;' datatype="n" sucmsg=" ">
                    </dd>
                </dl>
                 <dl>
                    <dt>是否置顶</dt>
                    <dd> 
                    <input name="txtISTOP" type="checkbox" id="txtISTOP"  runat="server"  class="input small" datatype="n" sucmsg=" ">
                    </dd>
                </dl>
                <dl>
                    <dt>是否启用</dt>
                    <dd> 
                    <input name="txtISUSED" type="checkbox" id="txtISUSED"  runat="server"  class="input small" datatype="n" sucmsg=" ">
                    </dd>
                </dl>
                <dl>
                    <dt>标题</dt>
                    <dd> 
                    <input name="txtTITLE" type="text" id="txtTITLE"  runat="server"  class="input small"  style='width:800px;' datatype="n" sucmsg=" ">
                    </dd>
                </dl>
                <dl>
                    <dt>内容</dt>
                    <dd> 
                    <textarea name="txtCONTENT" id="txtCONTENT" runat="server" style='width:800px;'   class="input big"></textarea>
                    </dd>
                </dl>
                <dl style='display:none;'>
                    <dt>备注</dt>
                    <dd> 
                      <input name="txtNOTE" type="hidden" id="txtNOTE"  runat="server"  class="input small"  style='width:600px;' datatype="n" sucmsg=" ">
                    </dd>
                </dl>
