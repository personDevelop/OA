...
INSERT INTO dbo.FunctionInfo (ID, Code, Name, ParentID, ParentName, IsEnable, Url, Note, Image, OrderNo)
VALUES ('1887BAEC-6CB5-407F-AEA4-62D7996F5662', '填写日志', '填写日志', 'C552B14A-0502-4183-896B-64C1E86B7BFA', '日常工作', 1, 'DayLogEdit.aspx', '', '', 2)
GO
...
VALUES ('5C0FCE6E-D98D-4F09-BD0E-6EF04111382A', 'admin', 'admin', 'admin@163.com', '管理员', '', '', 1, '1111', '111', '2014/01/01', 3, 0, '2014/01/01', '2014/01/01', NULL, '')
GO
DELETE dbo.RoleInfo 
GO

INSERT INTO dbo.RoleInfo (ID, Code, Name, RoleClass, IsEnable, Note)
VALUES ('C34697F5-944A-44FD-B5C8-67CB2410048A', 'admin', '管理员', '管理员', 1, '')
GO

INSERT INTO dbo.RoleInfo (ID, Code, Name, RoleClass, IsEnable, Note)
VALUES ('1EBADDBA-F543-480F-8AF1-87611CFBFADE', '员工', '员工', '', 1, '')
GO

INSERT INTO dbo.RoleInfo (ID, Code, Name, RoleClass, IsEnable, Note)
VALUES ('EA631369-F99F-466F-8F10-8A520BF1A67E', '数据录入人员', '数据录入人员', '', 1, '')
GO
